"""
FHE execute proof — 3-bit depth-4 50-tree (recommended setting), full illicit coverage.

Sample: ALL 1798 illicit + 1202 normal = 3000 rows (59.9% illicit).
Proves FHE execute==clear match across every illicit transaction in the test set.

Outputs:
  artifacts/execute_proof/execute_proof_3b4d_full_illicit.json
  artifacts/execute_proof/execute_proof_3b4d_full_illicit.log
"""
...
OUTPUT_JSON   = OUTPUT_DIR / "execute_proof_3b4d_full_illicit.json"
OUTPUT_LOG    = OUTPUT_DIR / "execute_proof_3b4d_full_illicit.log"
N_NORMAL_ROWS = 1202   # fills to 3000 alongside all 1798 illicit
RANDOM_SEED   = 42


def setup_logger(log_path: Path) -> logging.Logger:
    log_path.parent.mkdir(parents=True, exist_ok=True)
    logger = logging.getLogger("execute_proof_3b4d_full")
...
def main() -> None:
    ...
    logger.info("=== FHE Execute Proof — 3b4d50t full illicit (ALL illicit + %s normal) ===",
                N_NORMAL_ROWS)
    ...
    # All illicit + N_NORMAL_ROWS normal
    ...
    logger.info("Illicit coverage: %s / %s test illicit rows (%.1f%%)",
    ...
    output = {
        "experiment":        "execute_proof_3b4d_full_illicit",
